...
var incompleteTaskHolder=document.querySelector('.tasks-block__list_incompleted');//ul of #incompleteTasks
var completedTasksHolder=document.querySelector('.tasks-block__list_completed');//completed-tasks
...
var taskCompleted=function(){
    ...
    var label=listItem.querySelector(".task__text");
    label.classList.add("task__text_completed");
}
...
//Mark task as incomplete.
    ...
    bindTaskEvents(listItem,taskCompleted);
    var label=listItem.querySelector(".task__text");
    label.classList.remove("task__text_completed");
}
